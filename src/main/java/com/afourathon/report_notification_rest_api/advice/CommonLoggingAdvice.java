package com.afourathon.report_notification_rest_api.advice;
...
public class CommonLoggingAdvice {
	...
	@Pointcut(value="execution(* com.afourathon.report_notification_rest_api.controller.*.*(..)) && "
			+ "!execution(* com.afourathon.report_notification_rest_api.controller.*.getAll*(..))")
	...
	@Pointcut(value="execution(* com.afourathon.report_notification_rest_api.controller.*.getAll*(..))")
